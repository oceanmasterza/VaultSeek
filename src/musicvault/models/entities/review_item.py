...
from Phase 3 for the same reason as :class:`~musicvault.models.entities.job.Job`
— it is the return type :class:`~musicvault.db.repositories.review_repo.ReviewRepository`
