...
(:mod:`musicvault.models.value_objects.rule_condition`,
:mod:`musicvault.models.value_objects.rule_action`), but *loading* rules
...
shape :func:`~musicvault.models.value_objects.rule_condition.parse_conditions`
expects.
"""
