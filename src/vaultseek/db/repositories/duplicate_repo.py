...
joins here lets :class:`~vaultseek.models.services.duplicate_matcher.DuplicateMatcher`
...
from vaultseek.db.tables import duplicate_groups, duplicate_members, file_identity, tracks
