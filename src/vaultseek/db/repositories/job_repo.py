...
Converts between :class:`~vaultseek.models.entities.job.Job` (the
...
:mod:`vaultseek.db.uuid_utils` and the module docstring in
:mod:`vaultseek.db.tables` for the conventions this follows.
"""
...
from vaultseek.db.tables import jobs as jobs_table
...
class JobRepository:
    ...
    def count_by_status(self, library_id: UUID) -> dict[str, int]:
        ...
        aggregate :class:`~vaultseek.services.dto.job_dto.JobStatsDTO`
